...
const ResetForm = () => {
            ...
            <Form {...form}>
                <form  className="top-[88px] relative">
                    <div className="space-y-6 mr-[12px] ml-[12px]">
                        ...
                        id="sign-button"
                        >
                            <h3 className={font_primary.className}>Send reset email</h3>
                        </button>
                    </div>
                </form>
            </Form>
    ...
    <button id="google-auth" className="auth-buttons flex items-center justify-center relative bottom-[-10rem]" onClick={() => {router.push("/auth/login")}}><h3>Back</h3></button>
    </div>
